...
<Aside type="tip">
Use regex patterns for more flexible matching. The `.*` matches any characters, `\.` escapes dots, and `$` ensures end-of-string matching.
</Aside>
...
<Aside type="caution">
Some theme plugins may override icon settings. Try disabling other visual plugins to identify conflicts.
</Aside>
